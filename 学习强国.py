...
def dati(web):
    ...
    def danxuanti(web):
        ...
        button_tips.click()
        #返回答案
        answer_danxuan=web.find_element_by_xpath('//*[@id="body-body"]/div[4]/div/div/div/div[2]/div/div/div/font').get_attribute('textContent')
        ...
        for n,i in enumerate(chooseable):
            if i.text.split('.')[-1].strip()==answer_danxuan:
                button_sel=web.find_element_by_xpath('//*[@id="app"]/div/div[2]/div/div[4]/div[1]/div[4]/div['+str(n+1)+']')
    ...
    def tiankongti(web):
        ...
        if web.find_element_by_xpath('//*[@id="body-body"]/div[4]/div/div/div/div[2]/div/div/div').text=='请观看视频':
            ...
            #不是视频题就找答案
            answer_tiankong=web.find_element_by_xpath('//*[@id="body-body"]/div[4]/div/div/div/div[2]/div/div/div/font').get_attribute('textContent')
